...
public class BptiUsedSpark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkDl4jMultiLayer master = new SparkDl4jMultiLayer(sc,confFromJson);
        ...
        JavaRDD<DataSet> data = sc.parallelize(next.asList(), next.numExamples() / confFromJson.getConf(0).getBatchSize());
